                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">IMPRESORAS Y ESCÁNERES</h3>  
                                </div>                       
...
$consulta = "SELECT * FROM impresoras_escaneres D, edificios E
WHERE D.codigo_edificio = E.codigo_edificio;";

$resultado = mysqli_query( $conexion, $consulta );

while($fila = $resultado->fetch_assoc()) {
?><tr>
    <td> <?php echo $fila['codigo_impresora_escaner']; ?></td>
    <td> <?php echo $fila['marca_modelo']; ?></td>
    <td> <?php echo $fila['ip']; ?></td>
    <td> <?php echo $fila['departamento']; ?></td>
    <td><a href='editardispositivos.php?codigo_impresora_escaner=<?php echo $fila["codigo_impresora_escaner"]?>' class="btn btn-default" title="Modificar"><i class="fa fa-edit"></i></a>
    <a href='eliminardispositivos.php?codigo_impresora_escaner=<?php echo $fila["codigo_impresora_escaner"]?>&eliminar=1' class="btn btn-default" title="Eliminar"><i class="fa fa-trash-o"></i></a>
    </td>
</tr>
<?php
}
