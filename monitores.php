...
$consulta = "SELECT * FROM monitores M, edificios E
...
?><tr>
    <td> <?php echo $fila['codigo_monitor']; ?></td>
    <td> <?php echo $fila['marca_modelo']; ?></td>
    <td> <?php echo $fila['pulgadas']; ?></td>
    <td> <?php echo $fila['departamento']; ?></td>
    <td> <?php echo $fila['nombre_usuario']; ?></td>
    <td><a href='editarmonitores.php?codigo_monitor=<?php echo $fila["codigo_monitor"]?>' class="btn btn-default" title="Modificar"><i class="fa fa-edit"></i></a>
    <a href='eliminarmonitores.php?codigo_monitor=<?php echo $fila["codigo_monitor"]?>&eliminar=1' class="btn btn-default" title="Eliminar"><i class="fa fa-trash-o"></i></a>
    </td>
</tr>
<?php
}
